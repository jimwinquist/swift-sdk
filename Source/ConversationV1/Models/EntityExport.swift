...
public struct EntityExport {
    ...
    */
    public init(entityName: String, created: String, updated: String, description: String? = nil, metadata: [String: JSONValue]? = nil, fuzzyMatch: Bool? = nil, values: [ValueExport]? = nil) {
